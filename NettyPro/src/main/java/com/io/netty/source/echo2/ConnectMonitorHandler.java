 ...
 */
@Sharable
public class ConnectMonitorHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("ConnectMonitorHandler channelActive 的线程是=" + Thread.currentThread().getName());
    }
    
    @Override
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        super.channelInactive(ctx);
        System.out.println("ConnectMonitorHandler channelInactive 的线程是=" + Thread.currentThread().getName());
    }
    
    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {

        System.out.println("ConnectMonitorHandler channelRead 的线程是=" + Thread.currentThread().getName());
//        ctx.channel().close();
        //按照原来的方法处理耗时任务
        /*
        //解决方案1 用户程序自定义的普通任务
