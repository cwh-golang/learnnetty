 ...
 */
@Sharable
public class ConnectMonitorHandler extends ChannelDuplexHandler {
     ...
     */
    public ConnectMonitorHandler(LogLevel level) {
        if (level == null) {
     ...
     */
    public ConnectMonitorHandler(Class<?> clazz) {
     ...
     * @param level the log level
     */
    public ConnectMonitorHandler(Class<?> clazz, LogLevel level) {
        if (clazz == null) {
